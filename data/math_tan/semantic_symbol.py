...
from math_tan.math_symbol import MathSymbol
from math_tan.mathml import MathML
from math_tan.exceptions import UnknownTagException
    ...
    def parse_from_mathml(cls, elem, parent=None, identified=None):
        ...
        # operator tree leaves ...
            ...
            for child in list(elem):
                retval.children.append(cls.parse_from_mathml(child, retval))
            ...
            if content:
                ...
                children = list(elem)
                retval = cls.parse_from_mathml(children[0], parent, identified)
        ...
        # functions with special tags ...
                          ...
                          MathML.f, MathML.g, MathML.h, MathML.e, MathML.d, MathML.y,
                          MathML.prime, MathML.exponentiale]:
        ...
        # unordered operators
            ...
            retval = SemanticSymbol("U!" + short_tag, parent=parent)
                          ...
                          MathML.minus, MathML.divide, MathML.power,
